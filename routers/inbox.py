...
@router.get("/nde/mail/inbox/v1/", tags=["mail"])
def get_inboxes():
    return [
...
@router.get("/nde/mail/inbox/{nomor_surat}/v1", tags=["mail"])
def get_inbox_detail(id_surat: str):
    return {"body": "some important mail", "nomor_surat": id_surat}

@router.get("/nde/mail/inbox/send/v1/", tags=["mail"])
def get_inbox_send():
    return [
...
@router.post("/nde/mail/inbox/v1/", tags=["mail"])
